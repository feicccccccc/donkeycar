...
def get_model_by_type(model_type, cfg):
    ...
    if model_type == "tflite_linear":
    ...
    elif model_type == "imu2":
        kl = KerasIMU2(num_outputs=2, num_imu_inputs=12, input_shape=input_shape)
        ...
        kl = Keras_IMU_LSTM_Many2Many_Categorical(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, seq_length=cfg.SEQUENCE_LENGTH)
    elif model_type == "rnn_imu_many2many_imupred":
        kl = Keras_IMU_LSTM_Many2Many_IMUPRED(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, seq_length=cfg.SEQUENCE_LENGTH)
